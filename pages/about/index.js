...
const About = () => {
  ...
  return (
    <>
      ...
      {isEnglish ? (
        <ImageWithText
          url="/cheo/images/general/final/1.jpg"
      ...
      {isEnglish ? (
        <ImageWithText
          url="/cheo/images/general/final/3.jpg"
      ...
      {isEnglish ? (
        <ImageWithText
          url="/cheo/images/general/final/4.jpg"
      ...
      {isEnglish ? (
        <ImageWithText
          url="/cheo/images/general/final/5.1.jpg"
      ...
      {isEnglish ? (
        <ImageWithText
          url="/cheo/images/general/final/5.2.jpg"
      ...
      {isEnglish ? (
        <ImageWithText
          url="/cheo/images/general/final/6.jpg"
      ...
      {isEnglish ? (
        <ImageWithText
          url="/cheo/images/general/final/7.jpg"
      ...
      {isEnglish ? (
        <ImageWithText
          url="/cheo/images/general/final/8.jpg"
      ...
      {isEnglish ? (
        <ImageWithText
          url="/cheo/images/general/final/9.jpg"
          component={
            <div>
              <p>
      ...
      {isEnglish ? (
        <ImageWithText
          url="/cheo/images/general/final/10.jpg"
      ...
      {isEnglish ? (
        <ImageWithText
          url="/cheo/images/general/final/11.jpg"
      ...
      {isEnglish ? (
        <ImageWithText
          url="/cheo/images/general/final/12.jpg"
          component={
